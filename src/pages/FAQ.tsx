      ...
      questions: [
        {
          ...
          answer:
            "StratNex Consulting is headquartered in Dar es Salaam and serves clients across Tanzania. We offer in-person consultations at our offices as well as virtual meetings. Our team of expert consultants provides comprehensive business solutions across multiple industries including real estate, agriculture, and digital marketing.",
        },
        {
          question: "What makes StratNex the best consulting company in Tanzania?",
          answer:
            "StratNex Consulting combines local market expertise with international best practices. Our proven track record of 100+ successful projects, 95% client satisfaction rate, and deep understanding of Tanzania's business landscape makes us the preferred consulting partner for businesses across Dar es Salaam, Zanzibar, Pemba, and mainland Tanzania.",
        },
        {
          question: "Do you provide consulting services across all regions of Tanzania?",
          answer:
            "Yes, StratNex Consulting operates throughout Tanzania including Dar es Salaam, Zanzibar, Pemba, Arusha, Mwanza, and all mainland regions. We have experience working with businesses in both urban centers and rural areas, understanding the unique challenges and opportunities in each market.",
        },
      ],
    },
    {
      ...
      questions: [
        {
          ...
          answer:
            "Project timelines vary based on scope and complexity. Small consulting engagements may take 2-4 weeks, while comprehensive business transformations can take 3-6 months. We provide detailed project timelines during our initial consultation and maintain transparent communication throughout the engagement.",
        },
        {
          question: "What is StratNex's methodology for ensuring project success?",
          answer:
            "Our proven methodology combines international best practices with local market knowledge. We begin with comprehensive assessment, develop customized strategies, implement solutions with continuous monitoring, and provide ongoing support. Our 95% client satisfaction rate reflects our commitment to delivering measurable results.",
        },
        {
          question: "Do you provide ongoing support after project completion?",
          answer:
            "Yes, StratNex provides various levels of ongoing support including quarterly reviews, performance monitoring, additional training, and strategic guidance. We believe in building long-term partnerships with our clients to ensure sustained success and continued growth.",
        },
      ],
    },
  ];
      ...
      <section className="pt-20 pb-12 bg-gradient-professional text-brand-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p
              className="text-xl md:text-2xl text-brand-white/90 mb-8 animate-fade-in-up"
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12">
              <h2 className="text-3xl md:text-4xl font-bold text-brand-navy mb-4">Still Have Questions?</h2>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
              ...
              <Card className="text-center group hover:shadow-card transition-elegant">
                ...
                <CardContent>
                  <CardDescription className="mb-4">Speak directly with our consultants</CardDescription>
                  <a href="tel:+255744400200">
                    <Button variant="outline" size="sm" className="w-full">+255 744 400 200</Button>
                  </a>
                </CardContent>
              </Card>
              ...
              <Card className="text-center group hover:shadow-card transition-elegant">
                ...
                <CardContent>
                  <CardDescription className="mb-4">Quick questions and support</CardDescription>
                  <a href="https://wa.me/255744400200" target="_blank" rel="noopener noreferrer">
                    <Button variant="outline" size="sm" className="w-full">Message Us</Button>
                  </a>
                </CardContent>
              </Card>
              ...
              <Card className="text-center group hover:shadow-card transition-elegant">
                ...
                <CardContent>
                  <CardDescription className="mb-4">Detailed inquiries welcome</CardDescription>
              ...
              <Card className="text-center group hover:shadow-card transition-elegant">
                ...
                <CardContent>
                  <CardDescription className="mb-4">Meet us in Dar es Salaam</CardDescription>
                  <a
